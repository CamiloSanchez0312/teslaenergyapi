...
from .api import MedicionesAPIMeter, SubstationRegisterAPI, SubstationListAPI, TransformerRegisterAPI, TransformerListAPI, ElectricMeterRegisterAPI, ElectricMeterListAPI, SubstationByIdAPI, TransformerByIdAPI, ElectricMeterByIdAPI, MedicionesApi
...
urlpatterns = [
    ...
    url(r'^mediciones/test/$', MedicionesAPIMeter.as_view()),
]
