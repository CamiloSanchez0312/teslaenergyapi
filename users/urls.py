...
from .api import UserAPI, UserByIdAPI, UserByUsernameAPI, RegisterAPI, VerifyTokenAPI, UserRolByUsernameAPI
...
urlpatterns = [
    ...
    url(r'^rolbyusername/(?P<username>[a-z1-9A-Z]+)/$', UserRolByUsernameAPI.as_view(), name = 'rol-username-api'),
